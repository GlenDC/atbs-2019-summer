...
print("name,address,email,wallet")
for name, user in users.items():
    print("\"{}\",\"{}\",\"{}\",\"{}\"".format(name, user["address"], user["email"], user.get("wallet", "")))

# copy-paste this data into a new google sheet,
# and go to Data>split-text-to-columns, choose 'colon' and split the data.
